...
match args.pipe.lower():
    ...
    case 'finetune':
        ...
        if args.distributed:
            ...
            mp.spawn(finetune, args=(args.distributed, args.splits_path, args.corrupted, args.c_input_path, args.c_output_path), nprocs=world_size, kwargs={'batch_size': args.batch_size, 'world_size': world_size}, join=True)
        else:
