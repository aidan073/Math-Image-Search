...
match args.pipe.lower():
    ...
    case 'finetune':
        if not (args.splits_path and args.corrupted and args.c_input_path and args.c_output_path):
            raise argparse.ArgumentError(None, "Missing required arguments for finetune pipe. Usage: --pipe finetune -s <splits_path> -x <corrupted_files_path> -c <checkpoint_input_path> -o <checkpoint_output_path>")
        ...
        finetune(args.splits_path, args.corrupted, args.c_input_path, args.c_output_path)
