...
def quick_search_parser():
    ...
    parser.add_argument("--max_batch_size", type=int, default=100, help="Max number of samples per batch when encoding. Defaults to 100.")
...
def full_search_parser():
    ...
    parser.add_argument('--batch_size', '-b', type=int, default=100, help="Max number of samples per batch during encoding. Make this larger to speed up encoding, or smaller to prevent out of memory errors.")

def quick_search(checkpoint_path:str, search_type:str='t2i', texts_path:str=None, texts:Union[str, list[str]]=None, images_path:str=None, images:Union[Image.Image, list[Image.Image]]=None, output_path:str=None, max_batch_size:int=100, top_n:int=100)->dict[int, list[int]]:
    """
    ...
    Args:
        ...
        max_batch_size (Default=100): Max number of samples to encode at once. Make this lower to lower the memory usage, or higher to speed up the encoding.
...
def longclip_search(checkpoint_path:str, test_split_path:dict, output_path:str=None, missing_or_corrupted:str=None, batch_size:int=100)->Run:
    """
...
if __name__ == "__main__":
    ...
    longclip_search(args.c_input_path, args.test_split_path, args.results_path, args.missing_or_corrupted, args.batch_size)
